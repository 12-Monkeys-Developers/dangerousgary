...
export default class DangerousGaryCharacterSheet extends HandlebarsApplicationMixin(sheets.ActorSheetV2) {
  ...
  static DEFAULT_OPTIONS = {
    ...
    actions: {
      edit: DangerousGaryCharacterSheet.#onItemEdit,
      delete: DangerousGaryCharacterSheet.#onItemDelete,
      rollSave: DangerousGaryCharacterSheet.#onItemRollSave,
  ...
  _getHeaderControls() {
    ...
    if (!controls.find((c) => c.action === "shortRest")) {
      controls.push({
        ...
        label: "DANGEROUSGARY.Labels.long.shortRest",
        action: "shortRest",
      })
    }
